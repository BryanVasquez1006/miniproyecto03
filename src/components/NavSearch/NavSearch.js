      ...
      {navExpand ? (
        <div>
          <Nav expand onClick={Open}>
            <Input placeholder="Location" expandInput radius value={location}/> {/* HERE IT IS THE VALUE I NEED TO MAKE THE FILTER */}
            ...
            <Button expandBtn onClick={Filtering} onChange>
